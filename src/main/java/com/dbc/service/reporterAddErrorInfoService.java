...
@Service
public class reporterAddErrorInfoService {

                    public List<String> AddErrorInfo(){
                    ...
                    params.add("--func");
                    params.add("reporterAddErrorInfo");
                    params.add("--js");
                    ...
                    params.add("0");
                    params.add("5CiPPseXPECbkjWCa6MnjNokrgYjMqmKndv2rSnekmSK2DjL");
                    params.add("0x");
                    params.add("0x");
